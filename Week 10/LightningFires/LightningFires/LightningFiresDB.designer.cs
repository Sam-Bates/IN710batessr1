...
namespace LightningFires
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="IN700001_201601_BATESSR1")]
	public partial class LightningFiresDBDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeletetblPicture(tblPicture instance);
		...
		public LightningFiresDBDataContext() : 
				base(global::LightningFires.Properties.Settings.Default.IN700001_201601_BATESSR1ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public LightningFiresDBDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LightningFiresDBDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LightningFiresDBDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LightningFiresDBDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
